...
class Pnumline(models.Model):
    ...
    count_line_po = fields.Integer(string="num of Products",compute='_compute_po_order_line', required=False,)
...
class Sonumline(models.Model):
    _inherit = 'sale.order'
    count_line_so = fields.Integer(string="num of Products",compute='_compute_sale_order_line', required=False,)
...
class accountnumline(models.Model):
    ...
    count_line_am = fields.Integer(string="num of Products", compute='_compute_account_invoice', required=False, )
