...
class PosQuotationLine(models.Model):
    ...
    tax_ids = fields.Many2many('account.tax', string='Taxes',relation="taxids", column1="tax", column2="ids", readonly=True)
    tax_ids_after_fiscal_position = fields.Many2many('account.tax',relation="tax", column1="taxes", column2="position",string='Taxes')
